...
readonly SCRIPT_DIR
readonly RULES_SRC="${SCRIPT_DIR}/../config/realsense/udev/99-realsense-libusb.rules"
...
Copies config/realsense/udev/99-realsense-libusb.rules to /etc/udev/rules.d/ and
