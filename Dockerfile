...
# config/realsense/yaml/none.yaml, so /camera_config.yaml is 0 bytes and the
...
# --build-arg CAMERA_CONFIG=config/realsense/yaml/usb2_640x480p15fps.yaml) selects a profile.
