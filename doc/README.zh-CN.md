...
- **Apt 安装**：从 ROS 2 apt 软件源安装 `realsense2_camera` 和 `librealsense2`
...
# 2. 运行（默认：realsense2_camera rs_launch.py）
./run.sh
...
| `runtime` | `ros:humble-ros-base-jammy` | RealSense 软件包 + udev 规则 |
